/**
 * @sophiaxt/seo-connector-wordpress — STUB (later).
 *
 * Declared so the connector architecture can reference WordPress, but NOT
...
export class WordPressConnector extends StubConnector {
  readonly id: string;
